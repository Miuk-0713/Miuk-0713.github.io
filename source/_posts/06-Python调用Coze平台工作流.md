...
![image-20250813145826661](/img/posts/image-20250813145826661.png)
...
![image-20250813150058212](/img/posts/image-20250813150058212.png)
...
![image-20250813150925985](/img/posts/image-20250813150925985.png)

### 2.3 授权API key

左侧窗口下滑，可以看到token，这就是API Key，点击授权

![image-20250813151145365](/img/posts/image-20250813151145365.png)

点击“授权”后自动生成并填充 API Key

![image-20250813151323753](/img/posts/image-20250813151323753.png)
...
![image-20250813151718254](/img/posts/image-20250813151718254.png)

### 2.5 运行

可以直接点击Shell命令窗口右上角的“运行”按钮

![image-20250813151931238](/img/posts/image-20250813151931238.png)
...
![image-20250813152407941](/img/posts/image-20250813152407941.png)
...
![image-20250813152519965](/img/posts/image-20250813152519965.png)

此处的content是工作流的输出。

Done是最后一个响应，表示工作流执行完毕，在Message响应之后。

![image-20250813152856481](/img/posts/image-20250813152856481.png)

## 3.通过python代码调用工作流

### 3.1 官方提供了调用API的Python代码

![image-20250813153047412](/img/posts/image-20250813153047412.png)
...
![image-20250815014406971](/img/posts/image-20250815014406971.png)

需要补充代码：

![image-20250815014227105](/img/posts/image-20250815014227105.png)
...
![image-20250815014200569](/img/posts/image-20250815014200569.png)
...
![image-20250813154738952](/img/posts/image-20250813154738952.png)
